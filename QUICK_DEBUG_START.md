...
#### Option 2: Use Current Build 28 (Firestore-Only Testing)
1. **Launch Build 28** on iOS device via TestFlight
2. **Look for login screen** with "BUILD 28 - FIRESTORE TEST"
...
7. **🚫 DO NOT test camera functionality** (saved for Build 29)

**Build 28 Strategy**: Testing Firebase Firestore operations ONLY on proven Build 25 authentication foundation
